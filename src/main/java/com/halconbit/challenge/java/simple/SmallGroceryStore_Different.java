 ...
 */
public class SmallGroceryStore_Different {
    
    public static void main(String[] args) {
        
        double salary = 0.00;
        // We have 3 types of employees:
        // 1- Stocker, 2 - Cashier 25.630,89, 3 - Supervisor 35.560,20 
        
        System.out.println("Enter the type employee.");
        ...
        if(category == 1 || category == 2 || category == 3) {
            System.out.println("The person's category is: " + category);
            System.out.println("The person's salary is: "   + salary);
        }
