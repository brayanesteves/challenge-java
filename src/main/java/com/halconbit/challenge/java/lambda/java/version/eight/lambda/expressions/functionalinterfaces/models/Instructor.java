package com.halconbit.challenge.java.lambda.java.version.eight.lambda.expressions.functionalinterfaces.models;
...
public class Instructor {
    ...
    public String toString() {
        return "Instructor{" + "name=" + name + ", yearsOfExperience=" + yearsOfExperience + ", title=" + title + ", gender=" + gender + ", onlineCourses=" + onlineCourses + ", courses=" + courses + '}';
    }
